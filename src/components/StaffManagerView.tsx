  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-slate-900/90 backdrop-blur-md rounded-3xl border border-slate-800 shadow-xl p-5 space-y-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-xs">
              <thead>
                <tr className="bg-slate-950 text-slate-400 font-black uppercase text-[10.5px] border-b border-slate-800">
                  ...
                  return (
                    <tr key={idx} className="hover:bg-slate-800/40 transition-colors">
                      ...
                      <td className="py-3.5 px-3.5">
                        {isMaster ? (
                          <span className="px-2.5 py-1 rounded-lg bg-rose-500/10 text-rose-300 font-black text-[10.5px] border border-rose-500/20">
                          ...
                          <select
                            ...
                            className="bg-slate-950 border border-slate-800 rounded-xl px-2.5 py-1 text-xs font-semibold text-slate-200 focus:outline-none"
                          >
        ...
        <div className="bg-slate-900/90 backdrop-blur-md rounded-3xl border border-slate-800 shadow-xl p-5 space-y-4">
          ...
          <div className="space-y-2 max-h-96 overflow-y-auto pr-1">
            {savedCoaches.map((coachName) => (
              <div
                key={coachName}
                className="p-3 bg-slate-950/80 border border-slate-800/80 rounded-2xl flex items-center justify-between text-xs font-bold text-slate-200 hover:border-slate-700 transition-all"
              >
                <span>{coachName}</span>
                {userRole === 'admin' && (
                  <button
