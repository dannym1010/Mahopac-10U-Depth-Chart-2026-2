...
export const StaffManagerView: React.FC<StaffManagerViewProps> = ({
  ...
  const [newStaffIdleTimeout, setNewStaffIdleTimeout] = useState<number>(10);
              ...
              <div className="flex items-center gap-1.5 flex-wrap">
                ...
                {[10, 15, 30, 60, 120, 0].map((mins) => (
                  <button
                    ...
                    title={`Set all coaches to ${mins === 0 ? 'Never' : `${mins} min`} timeout`}
                  >
                    {mins === 0 ? 'Never' : `${mins}m`}
                  </button>
                ))}
                      ...
                      <td className="py-3.5 px-3">
                        {userRole === 'admin' ? (
                          <div className="flex items-center gap-1.5 min-w-[145px]">
                            ...
                            <select
                              value={coach.idleTimeoutMinutes !== undefined ? coach.idleTimeoutMinutes : 10}
                              onChange={(e) => {
                            ...
                            >
                              <option value={10}>10 Min (Default)</option>
                          ...
                          <span className="text-[11px] text-slate-300 font-medium flex items-center gap-1">
                            ...
                            <span>
                              {coach.idleTimeoutMinutes === 0
                                ? 'Disabled (Never)'
                                : `${coach.idleTimeoutMinutes || 10} Min`}
                            </span>
                          </span>
                        )}
                      </td>
