  ...
  return (
    <div className="space-y-4 sm:space-y-6 pb-28 md:pb-12 max-w-7xl mx-auto px-1 sm:px-2 md:px-0">
      {/* =========================================================================
          ...
          ========================================================================= */}
      <div className="bg-gradient-to-r from-slate-900 via-slate-900 to-indigo-950/70 border border-slate-800 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 sm:gap-6 relative z-10">
          <div className="space-y-1.5 sm:space-y-2">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="px-2.5 sm:px-3 py-1 rounded-full text-[10px] sm:text-[11px] font-black tracking-wider uppercase bg-indigo-500/20 text-indigo-300 border border-indigo-500/30">
                Football Command Center
              </span>
              <span className="px-2.5 sm:px-3 py-1 rounded-full text-[10px] sm:text-[11px] font-black tracking-wider uppercase bg-slate-800 text-slate-300 border border-slate-700">
                Week {currentWeek}
              </span>
          ...
          <div className="flex flex-wrap sm:flex-nowrap items-stretch sm:items-center gap-2 sm:gap-3 shrink-0 pt-1 lg:pt-0">
            {teams.length > 1 && (
              <div className="flex flex-col gap-1 min-w-[130px] flex-1 sm:flex-initial">
                ...
                <select
                  ...
                  className="bg-slate-950 border border-slate-700 rounded-xl px-3 py-2 text-xs font-bold text-white focus:outline-none focus:border-indigo-400 cursor-pointer shadow-md"
                >
                  {teams.map((t) => (
            ...
            <div className="bg-slate-950/80 border border-slate-800 rounded-2xl px-3.5 sm:px-4 py-2 sm:py-2.5 flex items-center gap-2.5 sm:gap-3 shadow-md flex-1 sm:flex-initial">
            ...
            <button
              ...
              className="w-full sm:w-auto bg-slate-950/80 hover:bg-slate-800 border border-slate-800 hover:border-emerald-500/50 rounded-2xl px-3.5 sm:px-4 py-2 sm:py-2.5 flex items-center justify-center sm:justify-start gap-2.5 sm:gap-3 shadow-md transition-all cursor-pointer group active:scale-98"
              title="Open Take Practice Attendance Roll Call"
            >
              <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-xl bg-emerald-500/20 text-emerald-400 flex items-center justify-center group-hover:scale-110 transition-transform shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        {/* -------------------------------------------------------------
            ...
            ------------------------------------------------------------- */}
        <div className="bg-slate-900/90 border border-slate-800 hover:border-emerald-500/40 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-xl flex flex-col justify-between transition-all group">
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex items-center justify-between gap-2 flex-wrap sm:flex-nowrap">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {practiceEventData?.event?.attireCategory && (
                  <span className="px-2 sm:px-2.5 py-0.5 rounded-lg text-[10px] font-black uppercase tracking-wider bg-slate-800 text-slate-300 border border-slate-700">
              ...
              {practiceEventData?.event?.startTime && (
                <span className="text-xs font-black text-amber-300 flex items-center gap-1 bg-slate-950 px-2.5 py-1 rounded-xl border border-slate-800 shrink-0">
            ...
            {practiceEventData ? (
              <div className="space-y-3">
                <div>
                  <h2 className="text-lg sm:text-xl md:text-2xl font-black text-white group-hover:text-emerald-300 transition-colors">
                ...
                {practiceEventData.plan ? (
                  <div className="p-3 sm:p-3.5 bg-slate-950/70 rounded-2xl border border-slate-800/70 space-y-2">
          ...
          <div className="pt-4 sm:pt-5 mt-3 sm:mt-4 border-t border-slate-800/80 space-y-2">
            <button
              type="button"
            ...
            <button
              type="button"
              onClick={() => onNavigateToUnit('compliance', { openTakeAttendance: true })}
              className="w-full min-h-[44px] py-2.5 px-4 bg-slate-950 hover:bg-slate-850 border border-slate-800 hover:border-emerald-500/50 text-slate-200 hover:text-white rounded-2xl text-xs font-bold flex items-center justify-center gap-2 transition-all cursor-pointer shadow-md group active:scale-98"
        ...
        {/* -------------------------------------------------------------
            ...
            ------------------------------------------------------------- */}
        <div className="bg-slate-900/90 border border-slate-800 hover:border-indigo-500/40 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-xl flex flex-col justify-between transition-all group">
          <div className="space-y-3 sm:space-y-4">
            {/* Header / Badge */}
            <div className="flex items-center justify-between gap-2 flex-wrap sm:flex-nowrap">
              <div className="flex items-center gap-2 flex-wrap">
              ...
              {gameEventData?.event.startTime && (
                <span className="text-xs font-black text-rose-300 flex items-center gap-1 bg-slate-950 px-2.5 py-1 rounded-xl border border-slate-800 shrink-0">
            ...
            {gameEventData ? (
              <div className="space-y-3">
                <div>
                  <h2 className="text-lg sm:text-xl md:text-2xl font-black text-white group-hover:text-rose-300 transition-colors">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="p-2.5 sm:p-3 bg-slate-950/70 rounded-2xl border border-slate-800/70">
          ...
          <div className="pt-4 sm:pt-5 mt-3 sm:mt-4 border-t border-slate-800/80 space-y-2">
            <button
              ...
              className="w-full min-h-[46px] py-3 px-4 bg-gradient-to-r from-rose-600 via-rose-500 to-indigo-600 hover:from-rose-500 hover:to-indigo-500 text-white font-black text-xs sm:text-sm rounded-2xl shadow-lg shadow-rose-600/20 flex items-center justify-center gap-2 cursor-pointer transition-all active:scale-98"
            >
            ...
            <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
              <button
                ...
                className="min-h-[42px] py-2 sm:py-2.5 px-1.5 sm:px-2 bg-slate-950 hover:bg-slate-800 border border-slate-800 text-slate-300 hover:text-white rounded-xl text-[11px] sm:text-xs font-bold flex items-center justify-center gap-1 transition-all cursor-pointer active:scale-98"
              ...
              >
                <Watch className="w-3.5 h-3.5 text-blue-400 shrink-0" />
              ...
              <button
                ...
                className="min-h-[42px] py-2 sm:py-2.5 px-1.5 sm:px-2 bg-slate-950 hover:bg-slate-850 border border-slate-800 text-slate-300 hover:text-white rounded-xl text-[11px] sm:text-xs font-bold flex items-center justify-center gap-1 transition-all cursor-pointer active:scale-98"
