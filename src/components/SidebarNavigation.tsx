    ...
    <>
      ...
      >
        ...
        {/* ===================================================================
            ...
            =================================================================== */}
        {isExpanded && (
          <div className="px-3 pt-3 pb-2 border-b border-slate-800/60 bg-slate-950/40">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-7 py-1.5 text-xs bg-slate-900 border border-slate-700/80 rounded-xl text-slate-200 placeholder-slate-400 focus:outline-hidden focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all font-medium"
              />
              {drillSearchFilter && (
                <button
                  type="button"
                            ...
                            <div
                              ...
                              className={`flex items-center justify-between px-2.5 py-1.5 rounded-lg cursor-pointer transition-all border text-xs font-bold ${
                                isFolderSelected
                                  ...
                                  : 'bg-slate-900/40 hover:bg-slate-800/80 text-slate-300 hover:text-white border-slate-800/50'
                              }`}
                            >
                              ...
                              <div className="flex items-center gap-1.5 shrink-0">
                                <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-slate-800 text-slate-300 font-mono border border-slate-700/60 font-bold">
                                  {drillsInFolder.length}
                                </span>
                                <ChevronRight
                                  className={`w-3 h-3 transition-transform ${
                                    isFolderOpen ? 'rotate-90 text-indigo-400' : 'text-slate-500'
                                  }`}
                                />
                              </div>
                            </div>
                                    ...
                                    return (
                                      <div key={subCat} className="space-y-1">
                                        ...
                                        >
                                          ...
                                          <div className="flex items-center gap-1.5 shrink-0">
                                            <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-slate-800 text-indigo-300 font-mono border border-indigo-900/60 font-bold">
                                              {subDrills.length}
                                            </span>
                                            <ChevronRight
                                              className={`w-3 h-3 transition-transform ${
                                                isSubOpen ? 'rotate-90 text-indigo-400' : 'text-slate-500'
                                              }`}
                                            />
                                          </div>
                                        </div>
                                        ...
                                        {isSubOpen && (
                                          <div className="ml-3 pl-2.5 border-l border-slate-700/50 space-y-1 py-1">
                                              ...
                                              return (
                                                ...
                                                >
                                                  ...
                                                  <div className="flex items-center gap-1 shrink-0 opacity-80 group-hover/drill:opacity-100">
                                                    <span className="text-[9px] font-mono uppercase px-1 rounded bg-slate-800/80 text-slate-300 font-bold">
              ...
              return (
                <div key={item.id} className="relative group">
                  ...
                  >
                    <div className="relative shrink-0 flex items-center justify-center w-7 h-7">
                      <Layers
                        className={`w-5 h-5 ${active ? 'text-white stroke-[2.5]' : 'text-indigo-400'}`}
                      />
                    </div>
                  ...
                  {isExpanded && isDepthChartOpen && (
                    <div className="mt-1.5 ml-3 pl-3 border-l-2 border-indigo-500/30 space-y-1 animate-in fade-in slide-in-from-top-2 duration-150">
                      {[
                        ...
                        { id: 'scrimmage', label: '⚔️ Scrimmage 11v11 Rotation' },
                      ].map((sub) => {
                        const isSubActive =
              ...
              <div key={item.id} className="relative group">
                ...
                >
                  <div className="shrink-0 flex items-center justify-center w-7 h-7">
                    <Icon
                      className={`w-5 h-5 ${
                        active ? 'text-white stroke-[2.5]' : 'text-slate-400 group-hover:text-white'
                      }`}
                    />
                  </div>
