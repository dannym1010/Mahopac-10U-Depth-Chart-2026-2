...
export const CallSheetMainView: React.FC<CallSheetMainViewProps> = ({
  ...
  return (
    <div className="h-[calc(100vh-4.5rem)] bg-slate-900 text-slate-100 flex flex-col font-sans overflow-hidden callsheet-root-container print:h-auto print:overflow-visible print:bg-white print:text-black">
      ...
      <header className="bg-slate-800/90 backdrop-blur-xs border-b border-slate-700/80 px-3 sm:px-5 py-1.5 shrink-0 shadow-xs print:hidden">
        <div className="max-w-[1500px] mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-2">
          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            ...
            <div className="flex items-center bg-slate-900/90 p-0.5 rounded-lg border border-slate-700 shadow-inner">
              <button
                type="button"
